 ...
 *
 * The followings are the available columns in table 'db_book':
 * @property integer $id
...
class Book extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('text_preview', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, year, description, text_preview', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('text_preview',$this->text_preview,true);
